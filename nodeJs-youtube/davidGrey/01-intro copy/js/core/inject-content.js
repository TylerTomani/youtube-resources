...
export const navLessonTitle = document.querySelector('nav.section-lesson-title');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const parts = document.querySelectorAll('li > a');
    ...
    parts.forEach((el, index) => {
        ...
        el.addEventListener('keydown', (e) => {
            ...
            if (!mainTargetDivFocused && !e.shiftKey) {
                if (letter === 'f') {
